<?php
$token = "5216327705:AAGjki5YGU0w2ku_Uc23QPhOgZTUS44oLAU";
...
if($text == "/help"){
    ...
    'reply_markup' => json_encode(['inline_keyboard' => [[['text'=>'- الدعم','url'=>"t.me/u660p"]],]])]);}
if($text == '/start' or $text == 'start' or $text == 'ابدء'  or $text == 'عمر'  or $text == 'Start'){ 
bot('sendphoto',[
'chat_id'=>$chat_id, 
'photo'=>"https://t.me/rmd_2022/78",
'caption'=>'- مرحبا بك في بوت مسلسلات رمضان 
- يتم عرض جميع المسلسلات يوميا 
-  قناه التحديثات : @cinemacq 
- مطور البوت : @u660p',
...
[['text'=>'- قناة البوت','url'=>"t.me/cinemacq"]],
[['text'=>'- جروب الطلبات','url'=>"t.me/cinemaorder"]],
[['text'=>'- الدعم','url'=>"t.me/u660p"]],
]])]);}
if($data == "start"){
